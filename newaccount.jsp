    ...
    <div class="inner-header flex" >
            ...
            <div class="row mt-5">
                <div class="card shadow px-5 pb-5 mb-3 text-dark mt-5" style="border-radius: 1rem;" id="modal_signin">
                    <form action="createnewaccount.do" method="POST" class="needs-validation">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class = "form-control form-control col-sm-6" placeholder="Enter Your Name" name="name" required>
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-sm-4 col-form-label">Email <span class="text-danger">*</span></label>
                            <input type="email" class="form-control form-control col-sm-6" placeholder="Enter your email" name="email" required>
                        </div>
                        <div class="form-group row">
                            <label for="contact" class="col-sm-4 col-form-label">Contact <span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control col-sm-5" placeholder="contact Number" name="contact" required>
                        </div>
                        <input type="submit" value="Create An Account" class="btn btn-lg btn-dark btn-block" id="signup_submit"></input>
                    </form>
